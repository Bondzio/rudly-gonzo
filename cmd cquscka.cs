...
[docs]    def add(self, cmd_name: str, qubits: Union[int, Iterable[int]],
...
[docs]    def has(self, cmd_name: str, qubits: Union[int, Iterable[int]]) -> bool:
...
[docs]    def get(self, cmd_name: str, qubits: Union[int, Iterable[int]],
...
[docs]    def get_parameters(self, cmd_name: str, qubits: Union[int, Iterable[int]]) -> Tuple[str]:
...
[docs]    def pop(self, cmd_name: str, qubits: Union[int, Iterable[int]],
            **params: Dict[str, Union[float, complex]]) -> Schedule:
...
[docs]    def cmds(self) -> List[str]:
        """Return all command names available in CmdDef."""

        return list(self._cmd_dict.keys())


[docs]    def cmd_qubits(self, cmd_name: str) -> List[Tuple[int]]:
